...
For other writing style guidance, see the [Ossiaco Style Guide](https://docs.ossiaco.com/style-guide/welcome/).
...
- Use relative links when linking to other content that is hosted on **docs.ossiaco.com**.
...
- When writing a conceptual article (as opposed to reference content), the first instance of a
  ...
  ```markdown
  This [Write-Host](/powershell/module/Ossiaco.PowerShell.Utility/Write-Host) cmdlet
