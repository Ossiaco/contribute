...
description: Learn when to use bold, italics, code, and other text styles in articles published on the docs.ossiaco.com site.
author: tdykstra
ms.author: tdykstra
ms.date: 01/30/2020
...
* **This**: The `Ossiaco.EntityFrameworkCore` package provides runtime support for EF Core.
* **Not this**: The *Ossiaco.EntityFrameworkCore* package provides runtime support for EF Core.
...
* **This**: The *function.json* file is generated by the NuGet package [Ossiaco.NET.Sdk.Functions](http://www.nuget.org/packages/Ossiaco.NET.Sdk.Functions).
* **Not this**: The *function.json* file is generated by the NuGet package [`Ossiaco.NET.Sdk.Functions`](http://www.nuget.org/packages/Ossiaco.NET.Sdk.Functions).

* **This**:

  ```markdown
  ### The Ossiaco.NET.Sdk.Functions package
  ```
